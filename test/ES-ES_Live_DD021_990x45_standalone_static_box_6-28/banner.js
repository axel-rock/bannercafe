...
eval("const bannerboy = __webpack_require__(/*! @bannerboy/bannerboy */ \"./node_modules/@bannerboy/bannerboy/index.js\")\nconst platform = __webpack_require__(/*! platform */ \"./platforms/dcm.js\")\nconst FontFaceObserver = __webpack_require__(/*! fontfaceobserver */ \"./node_modules/fontfaceobserver/fontfaceobserver.standalone.js\")\nconst unit = {\"id\":\"ES_Live_DD021_Prensa Iberica_0712\",\"name\":\"ES-ES_Live_DD021_990x45_standalone_static_box_6-28\",\"assetid\":\"DD021\",\"date\":\"6-28\",\"market\":\"es-es\",\"weight\":\"30kb\",\"dimensions\":\"990x45\",\"version\":\"Live\",\"responsive\":\"No\",\"hpto\":\"no\",\"specs\":\"https://www.prensaiberica360.es/formatos-publicitarios-digitales/cinta/\",\"platform\":\"dcm\",\"type\":\"jpg\",\"txtBox\":\"Dos días de ofertas épicas.\",\"txtDate\":\"12 - 13 julio\\n julio 12 - 13\",\"txtDisclaimer\":\"Solo para clientes Amazon Prime\",\"txtCtaLeadUp\":\"Ver más\",\"txtCtaLive\":\"Ver más\",\"logo\":\"amazon\\nprime day\",\"team\":\"Dev\",\"status\":\"Open\",\"rowNumber\":210,\"region\":\"eu\",\"template\":\"ultrawide\",\"otherSpreadsheetInfos\":{\"ROW #\":\"202\",\"Fallback (Y/N)\":\"No\",\"bb3k\":\"bb3k\",\"ASIN (Y/N)\":\"No\",\"Media Type\":\"Digital - Display standalone\",\"Unit Description\":\"Banner Desktop\",\"PSD (Y/N)\":\"no\",\"BB/Rufus Review Notes\":\"Missing HTML clicktag specs. 3rd party? https://support.google.com/admanager/answer/7046799 ok n/a n/a\",\"Requested/Available File Format\":\"JPG\",\"Additional URL for TR HPTO\":\"N/A\",\"Approved\":\"Approved\",\"Delivered\":\"Y\",\"missingTemplate\":\"990x45\"},\"rows\":3,\"cols\":3,\"branding\":\"amzpdeuultrawide\",\"creative\":\"Live\",\"txt\":{\"cta\":\"Ver más <span><span>›</span><span>›</span></span>\",\"legal\":\"Solo para clientes Amazon Prime\"},\"execution\":{\"package\":\"es-es\"},\"compression\":{},\"textOnly\":true,\"width\":990,\"height\":45}\nconst blueprint = (bannerboy.blueprint = {\"elements\":{\"box\":{\"left\":0,\"top\":0,\"width\":390,\"height\":330,\"id\":\"box\",\"parent\":\"banner\"},\"packageShadow\":{\"left\":0,\"top\":0,\"width\":390,\"height\":330,\"backgroundImage\":\"packageShadow.png\",\"retina\":true,\"img_scale\":2,\"id\":\"packageShadow\",\"parent\":\"box\"},\"package\":{\"left\":0,\"top\":0,\"width\":390,\"height\":330,\"backgroundImage\":\"package_es-es.png\",\"retina\":true,\"img_scale\":2,\"id\":\"package\",\"parent\":\"box\"}},\"images\":[\"packageShadow.png\",\"package_es-es.png\"],\"width\":990,\"height\":45,\"executions\":[],\"name\":\"ultrawide\"})\n\nconst animateCTA = __webpack_require__(/*! ../js/cta */ \"./templates/js/cta.js\")\n\nconst banner = document.getElementById('banner')\nconst cover = document.getElementById('cover')\nconst debug = window.location.href.indexOf('://localhost:') != -1\n\nif(unit.textOnly){\n  blueprint.images = []\n  blueprint.elements = []\n}\n\nplatform.init(blueprint, async (bb) => {\n  await new FontFaceObserver('Ember Bold', {weight: 300})\n    .load(null, 100)\n    .catch((error) => {\n      console.log('FontFaceObserver: ', error)\n    }) // Error handler for MS Edge only. Without this line, the banner doesn't show.\n  await new FontFaceObserver('Ember Regular', {weight: 300})\n    .load(null, 100)\n    .catch((error) => {\n      console.log('FontFaceObserver: ', error)\n    }) // Error handler for MS Edge only. Without this line, the banner doesn't show.\n\n  /* Init\n  ================================================= */\n\n  document.querySelectorAll('#logo').forEach((logo, index) => {\n    // console.log(logo, index)\n    logo.id += index + 1\n    logo.classList.add('logo')\n  })\n\n  // document.querySelector('#date1').innerHTML = unit.txtDate.split('\\n')[0]\n  // document.querySelector('#date2').innerHTML = unit.txtDate.split('\\n')[0]\n\n  // console.log(unit)\n\n  // console.log('ultrawide')\n\n  // createPattern(unit)\n  // scaleText(unit)\n  cover.remove()\n\n  /* Animations\n  ================================================= */\n\n  /* Main timeline\n  ================================================= */\n\n  if (debug) console.time('bannerTime')\n\n  if (unit.type.includes('html') || unit.type.includes('GIF')) {\n    const main_tl = gsap.timeline({id: 'main_tl'}).call(animateCTA)\n  }\n\n  /* Interactions\n  ================================================= */\n\n  banner.addEventListener('click', () => {\n    platform.clickthrough()\n  })\n})\n\n\n//# sourceURL=webpack:///./templates/ultrawide/banner.js?");
